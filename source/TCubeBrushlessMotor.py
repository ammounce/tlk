...
class TCubeBrushlessMotor(object):
    ...
    def __init__(self, lib_path="C:/Program Files/Thorlabs/Kinesis/"):
        ...
        self.lib = cdll.LoadLibrary(
            self.lib_path + "Thorlabs.MotionControl.TCube.BrushlessMotor.DLL")
        ...
        self.BMC_GetLEDswitches = self.lib.BMC_GetLEDswitches
        self.BMC_GetLEDswitches.restype = c_long
        self.BMC_GetLEDswitches.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.BMC_SetLEDswitches = self.lib.BMC_SetLEDswitches
        self.BMC_SetLEDswitches.restype = c_short
        self.BMC_SetLEDswitches.argtypes = [POINTER(c_char), c_long]
