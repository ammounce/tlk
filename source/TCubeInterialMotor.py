...
class TCubeInterialMotor(object):
    ...
    def __init__(self, lib_path="C:/Program Files/Thorlabs/Kinesis/"):
        ...
        self.TIM_EnableLastMsgTimer.argtypes = [
        ...
        self.TIM_GetButtonParameters.argtypes = [
            TIM_ButtonsMode, c_int32, c_int32, POINTER(c_char), TIM_Channels]
        ...
        self.TIM_GetButtonParametersStruct.argtypes = [
            TIM_ButtonParameters, POINTER(c_char), TIM_Channels]
        ...
        self.TIM_GetDriveOPParameters.argtypes = [
            c_int16, c_int32, c_int32, POINTER(c_char), TIM_Channels]
        ...
        self.TIM_GetDriveOPParametersStruct.argtypes = [
            TIM_DriveOPParameters, POINTER(c_char), TIM_Channels]
        ...
        self.TIM_GetJogParametersStruct.argtypes = [
            TIM_JogParameters, POINTER(c_char), TIM_Channels]
        ...
        self.TIM_GetNextMessage.argtypes = [
            c_ulong, c_long, c_long, POINTER(c_char)]
        ...
        self.TIM_LoadNamedSettings.argtypes = [
        ...
        self.TIM_MoveAbsolute.argtypes = [
            POINTER(c_char), TIM_Channels, c_int32]
        # *serialNo, channel, position

        self.TIM_MoveJog = self.lib.TIM_MoveJog
        self.TIM_MoveJog.restype = c_short
        self.TIM_MoveJog.argtypes = [
            POINTER(c_char), TIM_Channels, TIM_Direction]
        ...
        self.TIM_SetButtonParameters.argtypes = [
            POINTER(c_char), TIM_ButtonsMode, TIM_Channels, c_int32, c_int32]
        ...
        self.TIM_SetButtonParametersStruct.argtypes = [
            TIM_ButtonParameters, POINTER(c_char), TIM_Channels]
        # &buttonParameters, *serialNo, channel

        self.TIM_SetDriveOPParameters = self.lib.TIM_SetDriveOPParameters
        self.TIM_SetDriveOPParameters.restype = c_short
        self.TIM_SetDriveOPParameters.argtypes = [
            POINTER(c_char), TIM_Channels, c_int16, c_int32, c_int32]
        ...
        self.TIM_SetJogParametersStruct.argtypes = [
            TIM_JogParameters, POINTER(c_char), TIM_Channels]
        # &jogParameters, *serialNo, channel
        ...
        self.TIM_SetMaxPotStepRate.argtypes = [
            POINTER(c_char), TIM_Channels, c_int32]
        ...
        self.TIM_WaitForMessage.argtypes = [
            c_ulong, c_long, c_long, POINTER(c_char)]
        # *messageData, *messageID, *messageType, *serialNo
        ...
        self.TLI_GetDeviceInfo.argtypes = [
            TLI_DeviceInfo, POINTER(c_char), POINTER(c_char)]
        ...
        self.TLI_GetDeviceListByTypeExt.argtypes = [
            POINTER(c_char), c_ulong, c_int]
        ...
        self.TLI_GetDeviceListByTypesExt.argtypes = [
            POINTER(c_char), c_int, c_int, c_ulong]
