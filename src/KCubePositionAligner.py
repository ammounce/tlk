...
class KCubePositionAligner(object):
    ...
    def __init__(self, lib_path="C:/Program Files/Thorlabs/Kinesis/"):
        ...
        self.lib = cdll.LoadLibrary(
            self.lib_path + "Thorlabs.MotionControl.KCube.PositionAligner.DLL")

        self.QD_CanDeviceLockFrontPanel = self.lib.QD_CanDeviceLockFrontPanel
        self.QD_CanDeviceLockFrontPanel.restype = c_bool
        self.QD_CanDeviceLockFrontPanel.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.QD_GetClosedLoopPosition = self.lib.QD_GetClosedLoopPosition
        self.QD_GetClosedLoopPosition.restype = c_short
        self.QD_GetClosedLoopPosition.argtypes = [QD_ClosedLoopPosition, POINTER(c_char)]
        # *position, *serialNo
        ...
        self.QD_GetDigitalOutput = self.lib.QD_GetDigitalOutput
        self.QD_GetDigitalOutput.restype = c_short
        self.QD_GetDigitalOutput.argtypes = [QD_KPA_DigitalIO, POINTER(c_char)]
        # *digitalIO, *serialNo
        ...
        self.QD_GetFrontPanelLocked = self.lib.QD_GetFrontPanelLocked
        self.QD_GetFrontPanelLocked.restype = c_bool
        self.QD_GetFrontPanelLocked.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.QD_GetTriggerConfigParams = self.lib.QD_GetTriggerConfigParams
        self.QD_GetTriggerConfigParams.restype = c_short
        self.QD_GetTriggerConfigParams.argtypes = [POINTER(c_char), QD_KPA_TrigIOConfig]
        ...
        self.QD_RequestClosedLoopPosition = self.lib.QD_RequestClosedLoopPosition
        self.QD_RequestClosedLoopPosition.restype = c_short
        self.QD_RequestClosedLoopPosition.argtypes = [POINTER(c_char)]
        # *serialNo

        self.QD_RequestDigitalOutput = self.lib.QD_RequestDigitalOutput
        self.QD_RequestDigitalOutput.restype = c_short
        self.QD_RequestDigitalOutput.argtypes = [POINTER(c_char)]
        # *serialNo

        self.QD_RequestFrontPanelLocked = self.lib.QD_RequestFrontPanelLocked
        self.QD_RequestFrontPanelLocked.restype = c_short
        self.QD_RequestFrontPanelLocked.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.QD_RequestTriggerConfigParams = self.lib.QD_RequestTriggerConfigParams
        self.QD_RequestTriggerConfigParams.restype = c_short
        self.QD_RequestTriggerConfigParams.argtypes = [POINTER(c_char)]
        # *serialNo

        self.QD_SetClosedLoopPosition = self.lib.QD_SetClosedLoopPosition
        self.QD_SetClosedLoopPosition.restype = c_short
        self.QD_SetClosedLoopPosition.argtypes = [QD_ClosedLoopPosition, POINTER(c_char)]
        # *position, *serialNo

        self.QD_SetDigitalOutput = self.lib.QD_SetDigitalOutput
        self.QD_SetDigitalOutput.restype = c_short
        self.QD_SetDigitalOutput.argtypes = [QD_KPA_DigitalIO, POINTER(c_char)]
        # *digitalIO, *serialNo

        self.QD_SetFrontPanelLock = self.lib.QD_SetFrontPanelLock
        self.QD_SetFrontPanelLock.restype = c_short
        self.QD_SetFrontPanelLock.argtypes = [POINTER(c_char), c_bool]
        # *serialNo, locked
        ...
        self.QD_SetTriggerConfigParams = self.lib.QD_SetTriggerConfigParams
        self.QD_SetTriggerConfigParams.restype = c_short
        self.QD_SetTriggerConfigParams.argtypes = [POINTER(c_char), QD_KPA_TrigIOConfig]
        # *serialNo, *triggerParams
