...
class KCubeStepperMotor(object):
    ...
    def __init__(self, lib_path="C:/Program Files/Thorlabs/Kinesis/"):
        ...
        self.lib = cdll.LoadLibrary(
            self.lib_path + "Thorlabs.MotionControl.KCube.StepperMotor.DLL")

        self.SCC_CanDeviceLockFrontPanel = self.lib.SCC_CanDeviceLockFrontPanel
        self.SCC_CanDeviceLockFrontPanel.restype = c_bool
        self.SCC_CanDeviceLockFrontPanel.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_GetDigitalOutputs = self.lib.SCC_GetDigitalOutputs
        self.SCC_GetDigitalOutputs.restype = c_byte
        self.SCC_GetDigitalOutputs.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_GetFrontPanelLocked = self.lib.SCC_GetFrontPanelLocked
        self.SCC_GetFrontPanelLocked.restype = c_bool
        self.SCC_GetFrontPanelLocked.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_GetMMIParams = self.lib.SCC_GetMMIParams
        self.SCC_GetMMIParams.restype = c_short
        self.SCC_GetMMIParams.argtypes = [KMOT_WheelDirectionSense, c_int16,
        ...
        self.SCC_GetMMIParamsBlock = self.lib.SCC_GetMMIParamsBlock
        self.SCC_GetMMIParamsBlock.restype = c_short
        self.SCC_GetMMIParamsBlock.argtypes = [KMOT_MMIParams, POINTER(c_char)]
        # *mmiParams, *serialNo

        self.SCC_GetMMIParamsExt = self.lib.SCC_GetMMIParamsExt
        self.SCC_GetMMIParamsExt.restype = c_short
        self.SCC_GetMMIParamsExt.argtypes = [
            KMOT_WheelDirectionSense,
            c_int16,
            c_int16,
            c_int16,
        ...
        self.SCC_GetPIDLoopEncoderCoeff = self.lib.SCC_GetPIDLoopEncoderCoeff
        self.SCC_GetPIDLoopEncoderCoeff.restype = c_double
        self.SCC_GetPIDLoopEncoderCoeff.argtypes = [POINTER(c_char)]
        # *serialNo

        self.SCC_GetPIDLoopEncoderParams = self.lib.SCC_GetPIDLoopEncoderParams
        self.SCC_GetPIDLoopEncoderParams.restype = c_short
        self.SCC_GetPIDLoopEncoderParams.argtypes = [MOT_PIDLoopEncoderParams, POINTER(c_char)]
        # *params, *serialNo
        ...
        self.SCC_GetTriggerConfigParams = self.lib.SCC_GetTriggerConfigParams
        self.SCC_GetTriggerConfigParams.restype = c_short
        self.SCC_GetTriggerConfigParams.argtypes = [
            POINTER(c_char),
            KMOT_TriggerPortMode,
            KMOT_TriggerPortPolarity,
            KMOT_TriggerPortMode,
        ...
        self.SCC_GetTriggerConfigParamsBlock = self.lib.SCC_GetTriggerConfigParamsBlock
        self.SCC_GetTriggerConfigParamsBlock.restype = c_short
        self.SCC_GetTriggerConfigParamsBlock.argtypes = [POINTER(c_char), KMOT_TriggerConfig]
        # *serialNo, *triggerConfigParams

        self.SCC_GetTriggerParamsParams = self.lib.SCC_GetTriggerParamsParams
        self.SCC_GetTriggerParamsParams.restype = c_short
        self.SCC_GetTriggerParamsParams.argtypes = [
            c_int32,
            POINTER(c_char),
            c_int32,
            c_int32,
        ...
        self.SCC_GetTriggerParamsParamsBlock = self.lib.SCC_GetTriggerParamsParamsBlock
        self.SCC_GetTriggerParamsParamsBlock.restype = c_short
        self.SCC_GetTriggerParamsParamsBlock.argtypes = [POINTER(c_char), KMOT_TriggerParams]
        ...
        self.SCC_RequestDigitalOutputs = self.lib.SCC_RequestDigitalOutputs
        self.SCC_RequestDigitalOutputs.restype = c_short
        self.SCC_RequestDigitalOutputs.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_RequestFrontPanelLocked = self.lib.SCC_RequestFrontPanelLocked
        self.SCC_RequestFrontPanelLocked.restype = c_short
        self.SCC_RequestFrontPanelLocked.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_RequestMMIParams = self.lib.SCC_RequestMMIParams
        self.SCC_RequestMMIParams.restype = c_short
        self.SCC_RequestMMIParams.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_RequestPIDLoopEncoderParams = self.lib.SCC_RequestPIDLoopEncoderParams
        self.SCC_RequestPIDLoopEncoderParams.restype = c_short
        self.SCC_RequestPIDLoopEncoderParams.argtypes = [POINTER(c_char)]
        # *serialNo

        self.SCC_RequestPosTriggerParams = self.lib.SCC_RequestPosTriggerParams
        self.SCC_RequestPosTriggerParams.restype = c_short
        self.SCC_RequestPosTriggerParams.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_RequestTriggerConfigParams = self.lib.SCC_RequestTriggerConfigParams
        self.SCC_RequestTriggerConfigParams.restype = c_short
        self.SCC_RequestTriggerConfigParams.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.SCC_SetDigitalOutputs = self.lib.SCC_SetDigitalOutputs
        self.SCC_SetDigitalOutputs.restype = c_short
        self.SCC_SetDigitalOutputs.argtypes = [POINTER(c_char), c_byte]
        ...
        self.SCC_SetFrontPanelLock = self.lib.SCC_SetFrontPanelLock
        self.SCC_SetFrontPanelLock.restype = c_short
        self.SCC_SetFrontPanelLock.argtypes = [POINTER(c_char), c_bool]
        # *serialNo, locked
        ...
        self.SCC_SetMMIParams = self.lib.SCC_SetMMIParams
        self.SCC_SetMMIParams.restype = c_short
        self.SCC_SetMMIParams.argtypes = [
            POINTER(c_char),
            KMOT_WheelDirectionSense,
            c_int16,
            c_int32,
        ...
        self.SCC_SetMMIParamsBlock = self.lib.SCC_SetMMIParamsBlock
        self.SCC_SetMMIParamsBlock.restype = c_short
        self.SCC_SetMMIParamsBlock.argtypes = [KMOT_MMIParams, POINTER(c_char)]
        # *mmiParams, *serialNo

        self.SCC_SetMMIParamsExt = self.lib.SCC_SetMMIParamsExt
        self.SCC_SetMMIParamsExt.restype = c_short
        self.SCC_SetMMIParamsExt.argtypes = [
            POINTER(c_char),
            KMOT_WheelDirectionSense,
            c_int16,
            c_int16,
        ...
        self.SCC_SetPIDLoopEncoderCoeff = self.lib.SCC_SetPIDLoopEncoderCoeff
        self.SCC_SetPIDLoopEncoderCoeff.restype = c_short
        self.SCC_SetPIDLoopEncoderCoeff.argtypes = [POINTER(c_char), c_double]
        # *serialNo, coeff

        self.SCC_SetPIDLoopEncoderParams = self.lib.SCC_SetPIDLoopEncoderParams
        self.SCC_SetPIDLoopEncoderParams.restype = c_short
        self.SCC_SetPIDLoopEncoderParams.argtypes = [MOT_PIDLoopEncoderParams, POINTER(c_char)]
        # *params, *serialNo
        ...
        self.SCC_SetTriggerConfigParams = self.lib.SCC_SetTriggerConfigParams
        self.SCC_SetTriggerConfigParams.restype = c_short
        self.SCC_SetTriggerConfigParams.argtypes = [
            POINTER(c_char),
            KMOT_TriggerPortMode,
            KMOT_TriggerPortPolarity,
            KMOT_TriggerPortMode,
        ...
        self.SCC_SetTriggerConfigParamsBlock = self.lib.SCC_SetTriggerConfigParamsBlock
        self.SCC_SetTriggerConfigParamsBlock.restype = c_short
        self.SCC_SetTriggerConfigParamsBlock.argtypes = [POINTER(c_char), KMOT_TriggerConfig]
        # *serialNo, *triggerConfigParams

        self.SCC_SetTriggerParamsParams = self.lib.SCC_SetTriggerParamsParams
        self.SCC_SetTriggerParamsParams.restype = c_short
        self.SCC_SetTriggerParamsParams.argtypes = [
            POINTER(c_char),
            c_int32,
            c_int32,
            c_int32,
        ...
        self.SCC_SetTriggerParamsParamsBlock = self.lib.SCC_SetTriggerParamsParamsBlock
        self.SCC_SetTriggerParamsParamsBlock.restype = c_short
        self.SCC_SetTriggerParamsParamsBlock.argtypes = [POINTER(c_char), KMOT_TriggerParams]
        # *serialNo, *triggerParamsParams
        ...
        self.SCC_UsesPIDLoopEncoding = self.lib.SCC_UsesPIDLoopEncoding
        self.SCC_UsesPIDLoopEncoding.restype = c_bool
        self.SCC_UsesPIDLoopEncoding.argtypes = [POINTER(c_char)]
        # *serialNo
