...
class TCubeNanoTrack(object):
    ...
    def __init__(self, lib_path="C:/Program Files/Thorlabs/Kinesis/"):
        ...
        self.lib = cdll.LoadLibrary(
            self.lib_path + "Thorlabs.MotionControl.TCube.NanoTrak.DLL")
        ...
        self.NT_GetHubBay = self.lib.NT_GetHubBay
        self.NT_GetHubBay.restype = POINTER(c_char)
        self.NT_GetHubBay.argtypes = [POINTER(c_char)]
        # *serialNo
