...
class KCubeLaserDiode(object):
    ...
    def __init__(self, lib_path="C:/Program Files/Thorlabs/Kinesis/"):
        ...
        self.lib = cdll.LoadLibrary(
            self.lib_path + "Thorlabs.MotionControl.KCube.LaserDiode.dll")

        self.LD_CanDeviceLockFrontPanel = self.lib.LD_CanDeviceLockFrontPanel
        self.LD_CanDeviceLockFrontPanel.restype = c_bool
        self.LD_CanDeviceLockFrontPanel.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.LD_GetFrontPanelLocked = self.lib.LD_GetFrontPanelLocked
        self.LD_GetFrontPanelLocked.restype = c_bool
        self.LD_GetFrontPanelLocked.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.LD_GetRampupMode = self.lib.LD_GetRampupMode
        self.LD_GetRampupMode.restype = KLD_RAMPUP
        self.LD_GetRampupMode.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.LD_RequestFrontPanelLocked = self.lib.LD_RequestFrontPanelLocked
        self.LD_RequestFrontPanelLocked.restype = c_short
        self.LD_RequestFrontPanelLocked.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.LD_RequestMaxCurrent = self.lib.LD_RequestMaxCurrent
        self.LD_RequestMaxCurrent.restype = c_short
        self.LD_RequestMaxCurrent.argtypes = [POINTER(c_char)]
        # *serialNo

        self.LD_RequestRampupMode = self.lib.LD_RequestRampupMode
        self.LD_RequestRampupMode.restype = c_short
        self.LD_RequestRampupMode.argtypes = [POINTER(c_char)]
        # *serialNo
        ...
        self.LD_SetFrontPanelLock = self.lib.LD_SetFrontPanelLock
        self.LD_SetFrontPanelLock.restype = c_short
        self.LD_SetFrontPanelLock.argtypes = [POINTER(c_char), c_bool]
        # *serialNo, locked
        ...
        self.LD_SetMaxCurrent = self.lib.LD_SetMaxCurrent
        self.LD_SetMaxCurrent.restype = c_short
        self.LD_SetMaxCurrent.argtypes = [POINTER(c_char), c_long]
        # *serialNo, maxCurrent
        ...
        self.LD_SetRampupMode = self.lib.LD_SetRampupMode
        self.LD_SetRampupMode.restype = c_short
        self.LD_SetRampupMode.argtypes = [POINTER(c_char), KLD_RAMPUP]
        # *serialNo, rampupMode
        ...
        self.LD_StopFindTIAGain = self.lib.LD_StopFindTIAGain
        self.LD_StopFindTIAGain.restype = c_short
        self.LD_StopFindTIAGain.argtypes = [POINTER(c_char)]
        # *serialNo
